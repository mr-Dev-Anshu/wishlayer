  ...
  return (
    <div className="relative h-[411.39px] w-full flex justify-center items-center text-center text-white">
      ...
      <div className="absolute inset-0 bg-black bg-opacity-50 z-10 flex flex-col justify-center items-center p-4">
        ...
        <div className="w-full max-w-lg bg-white flex  sm:flex-row py-1 px-4 rounded-full mb-4">
          <input
            type="text"
            placeholder="Your Email Address..."
            className="w-full px-4 py-2 text-black rounded-full focus:outline-none mb-2 sm:mb-0 sm:mr-2"
          />
          <button className="md:px-4  py-1 bg-[#1950D1] font-semibold rounded-full text-white text-sm  w-[100px] hover:bg-red-600 focus:outline-none">
            Sign Up
          </button>
        </div>
      </div>
