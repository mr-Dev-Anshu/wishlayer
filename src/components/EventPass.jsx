  ...
  return (
    <div className="max-w-sm mx-auto  bg-white shadow-lg rounded-lg  ">
      <div className="  ">
        ...
        <button onClick={()=>setShowPass(!showPass)}  className="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg transition duration-300 ease-in-out">close</button>
      </div>
    </div>
  );
};
